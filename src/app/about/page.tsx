  ...
  return (
    <main>
      ...
      <section className={`${styles.missionVision} container`}>
        <h2>About Reshape Equipments</h2>
        <p>
          Reshape Equipments has led the way in offering patients around the US
          premium, long-lasting medical equipment (DME) since our establishment
          in 2020. We have successfully treated over 4,700 patients countrywide,
          assisting them in managing chronic ailments, recovering from injuries,
          and increasing their mobility and quality of life via our unwavering
          dedication to enhancing patient care and fostering general well-being.
        </p>
        <p>
          From continuous glucose monitors (CGMs) to orthopedic braces, our wide
          choice of DME products is made to fit the individual demands of every
          patient, guaranteeing that they get the correct equipment at the right
          time. We collaborate with leading insurance companies, such as Aetna,
          Cigna, BCBS, and UHC, to provide cost-effective options that are
          covered by the majority of health plans, facilitating patients' access
          to necessary medical equipment without putting a pressure on their
          finances.
        </p>
        <div className={styles.stage}>
          <div className={styles.item}>
            ...
            <div className={styles.content}>
              <h3>Our Mission</h3>
              <p>
                Our goal at Reshape Equipments is to improve patients' quality
                of life by making high-quality, long-lasting medical equipment
                easily accessible. Regardless of geography or medical condition,
                we think all patients should have access to the resources they
                need to take control of their health and live freely.
              </p>
              <p>
                By facilitating easy access to items that cater to each
                patient's unique needs, we hope to streamline the healthcare
                experience. Whether it's a continuous glucose monitor for
                diabetes control or an orthopedic brace for injury recovery, we
                ensure that every product is prescribed, authorized, and
                delivered with care.
              </p>
              <p>
                Our goal is to ensure that our patients receive the finest care
                possible without needless obstacles or hassles by bridging the
                gap between insurance companies, patients, and healthcare
                providers.
              </p>
            </div>
          </div>
          <div className={styles.item}>
            ...
            <div className={styles.content}>
              <h3>Our Vision</h3>
              <p>
                Our goal is to become the top supplier of long-lasting medical
                equipment in the US, renowned for our creativity, attention to
                detail, and dedication to accessibility. By offering smooth and
                reasonably priced solutions that simplify, expedite, and improve
                healthcare, we hope to revolutionize the way individuals get
                medical equipment.
              </p>
              <p>
                In order to help patients lead better lives, we hope to improve
                our services and increase the range of products we provide as we
                grow. In the future, Reshape Equipments will be known for its
                commitment to enhancing patient outcomes by providing superior,
                patient-centered care.
              </p>
              <p>
                Our mission is based on the conviction that everyone should have
                access to healthcare and that everyone has a right to the
                medical supplies they require in order to survive. By providing
                goods and services that enable our clients to live comfortably
                and independently while negotiating the difficulties of
                insurance coverage and medical needs, we hope to establish
                ourselves as a reliable healthcare partner.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className={`${styles.about} container`}>
        <div className={styles.content}>
          ...
          <p>
            Our dedication to quality and patient happiness is at the core of
            our offerings. We guarantee accessibility no matter where you are
            thanks to our large countrywide network. Our wide selection of
            superior items is made to accommodate different demands and provide
            useful solutions that genuinely have an impact.
          </p>
          <p>
            We are aware of how complicated healthcare may be, we provide our
            clients professional help with insurance coverage, which makes the
            process easier and less stressful. Above all, we continue to
            prioritize patient-centered care, guaranteeing individualized
            attention and steadfast support at every stage. We are a reliable
            partner in your healthcare journey because of these beliefs, which
            set us apart.
          </p>
          <ul>
      ...
      <section className={`${styles.services} container`}>
        ...
        <div className={styles.stage}>
          <div className={styles.tabs}>
            <div
              className={`${styles.item} ${
                activeTabs == "dme" ? styles.active : ""
              }`}
              onClick={() => setActiveTabs("dme")}
            >
              <svg
                width="40"
                height="40"
            ...
            <div
              className={`${styles.item} ${
                activeTabs == "caregiver" ? styles.active : ""
              }`}
              onClick={() => setActiveTabs("caregiver")}
            >
              <svg
                width="40"
                height="40"
          ...
          {activeTabs === "caregiver" && (
            <div
              className={`${styles.info} ${styles.activeInfo} ${styles.caregiverInfo}`}
            >
              <div className={styles.content}>
                <h3>Compassionate Support</h3>
                <p>
                  We recognize how important it is to find the best care for
                  your loved ones. Our staff of qualified caregivers is
                  committed to offering individuals in need individualized,
                  empathetic help. We guarantee their comfort, safety, and
                  well-being at every stage, whether we are caring for the
                  elderly, patients with long-term conditions, or those
                  recuperating after medical procedures. Our caregivers are
                  prepared to provide excellent care, including emotional
                  support, health monitoring, and help with everyday tasks. We
                  provide families with the assurance that their loved ones are
                  in skilled and compassionate hands by providing dependable,
                  responsive care.
                </p>
                <p>
                  A strong dedication to improving the quality of life for
                  individuals in need of care is at the core of our offerings.
                  With our customers, our caregivers establish deep connections
                  that promote security and trust. Our staff makes sure that
                  every need is satisfied with expertise and care, from
                  assisting with mobility and cleanliness to handling medication
                  scheduling and food preparation. By emphasizing friendship and
                  emotional well-being, we go above and beyond basic care,
                  providing a kind, personal touch that genuinely makes a
                  difference. We enable people to live comfortably, confidently,
                  and with dignity by providing them with our caring care.
                </p>
                <button
                  className="primary"
                  onClick={() => toggleDialog("braces")}
