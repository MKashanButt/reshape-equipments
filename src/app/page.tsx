    ...
    <main>
      ...
      <section className={`${styles.aboutUs} container`} id="aboutUs">
        ...
        <div className={styles.content}>
          <h2>About Us</h2>
          <p>
            Our goal at Reshape Equipments is to make your life and the lives of
            those you care easier, healthier, and more comfortable. We are here
            to offer specialized solutions that support independence and
            well-being because we recognize the special needs of seniors. We are
            committed to helping you at every stage of your path to better
          ...
          <p>
            ...
            their dependability and efficacy. Reshape Equipments makes certain
            that each item satisfies your particular requirements, delivering
            ease, security, and tranquility.
          </p>
          <p>
            ...
            when you work with Reshape Equipments, not just a client. Allow us
            to support you in living with grace, comfort, and the assurance that
            you have a reliable team on your side.
          </p>
          <button>
